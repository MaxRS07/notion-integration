...
export const Actions: React.FC<ActionsProps> = ({
    ...
    const hasTokens = !!settings.notionToken;
    const ACTIONS_STORAGE_KEY = `${applicationId}-actions`;
            ...
            <div className="integration-actions">
                <div className="actions-empty-state">
                    ...
                    <p className="empty-description">
                        Please configure your Notion token in Settings before creating actions.
                    </p>
                </div>
            </div>
        );
        ...
        <div className="integration-actions">
            <div className="automations-container">
                <div className="automations-header">
                    <div>
                        <h2 className="automations-title">{applicationName} Actions</h2>
                        <p className="automations-description">
                            Automated workflows for {applicationName}
                        </p>
                    </div>
                    <button
                ...
                {savedActions.length === 0 ? (
                    <div className="automations-empty">
                        ...
                        <p className="empty-description">
                            Create your first action to start automating {applicationName}
                        </p>
                        <button
                            className="button button-primary accent"
                            onClick={startCreateFlow}
